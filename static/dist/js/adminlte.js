  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    IFrame._jQueryInterface = function _jQueryInterface(config) {
      if ($__default["default"](SELECTOR_DATA_TOGGLE$1).length > 0) {
        ...
        localStorage.setItem('dist:IFrame:Options', JSON.stringify(_options));
        ...
        new IFrame($__default["default"](this), JSON.parse(localStorage.getItem('dist:IFrame:Options')))._initFrameElement();
      }
    };
